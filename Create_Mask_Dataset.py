...
without_dir = os.path.join(Default_Path,'raw_data/without_mask/')
...
for k in range(300,400):
    count = k
    img = cv2.imread(without_dir + without_files[k], 1)
    ...
    img2 = Image.open(without_dir + without_files[k])
    mask_img = Image.open('pink_mask.png')
    ...
    file_name_path = 'raw_data/with_mask/' + str(count)+'_with_pink_mask' + '.jpg' # your own repository path
    # file_name_path = 'test_data/' + str(count)+'_without_mask' + '.jpg' # your own repository path
